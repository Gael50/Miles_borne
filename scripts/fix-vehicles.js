...
vehiclesData = vehiclesData.replace(/  payday: \[\s*\[.*?\]\s*\]\,\s*\}\)\;/m, match => match.replace('});', '') + packs + '\n});');
fs.writeFileSync('src/entities/vehicles/data/vehicles.data.js', vehiclesData);
console.log('Fixed src/entities/vehicles/data/vehicles.data.js');
